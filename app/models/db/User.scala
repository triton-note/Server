...
object Users extends AnyIDTable[User]("USER") {
  val password = Column[Option[String]]("PASSWORD", (_.password), (_.getS.opt), attrString)
  ...
  val avatarUrl = Column[Option[String]]("AVATAR_URL", (_.avatarUrl), (_.getS.opt), attrString)
